...
def login():
   ...
   elif usernameEntry.get()=='Admin' and passwordEntry.get()=='1517':
...
loginFrame=Frame(window,bg='snow')
...
usernameLabel=Label(loginFrame,image=usernameImage,text='Username',compound=LEFT
                    ,font=('times new roman',20,'bold'),bg='white smoke')
...
loginButton=Button(loginFrame,text='Login',font=('times new roman',14,'bold'),width=15
                   ,fg='black',bg='papaya whip',cursor='hand2',command=login)
